...
/**
 * Test script for the analyzeTextQuality method
 * Run with: npx ts-node test-text-quality.ts
 */
async function testTextQuality() {
  console.log('🔬 Testing analyzeTextQuality method...\n');
  ...
  try {
    ...
    console.log(`📋 Using model: ${llmService.getDefaultModel()}\n`);
