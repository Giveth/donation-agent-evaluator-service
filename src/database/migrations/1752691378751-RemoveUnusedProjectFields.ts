...
export class RemoveUnusedProjectFields1752691378751
  implements MigrationInterface
{
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "project_social_accounts" ADD "total_reactions" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "project_social_accounts" ADD "verified" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
